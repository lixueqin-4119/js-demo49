...
function (_EventBus) {
  ...
  function Model(options) {
    ...
    _this = _super.call(this); //调用EventBus#constructor()
...
var init = function init(el) {
  new _View.default({
    ...
    render: function render(data) {
      ...
      (0, _jquery.default)(this.html.replace('{{n}}', n)).prependTo(this.el);
    },
    events: {
      'click #add1': 'add1',
      'click #minus1 ': 'minus1',
...
var _default = init;
exports.default = _default;
},{"./app1.css":"app1.css","jquery":"../node_modules/jquery/dist/jquery.js","./base/Model.js":"base/Model.js","./base/View.js":"base/View.js","./base/EventBus":"base/EventBus.js"}],"app2.css":[function(require,module,exports) {
var reloadCSS = require('_css_loader');
...
var init = function init(el) {
  ...
  new _View.default({
    ...
    render: function render(data) {
      ...
      if (this.el.children.length !== 0) this.el.empty();
      (0, _jquery.default)(this.html(index)).prependTo(this.el);
    },
    events: {
      'click .tab-bar li': 'x'
    },
...
var _default = init; //导出初始化方法

exports.default = _default;
},{"./app2.css":"app2.css","jquery":"../node_modules/jquery/dist/jquery.js","./base/Model.js":"base/Model.js","./base/View.js":"base/View.js","./base/EventBus":"base/EventBus.js"}],"app3.css":[function(require,module,exports) {
var reloadCSS = require('_css_loader');
...
//img.remove()
(0, _app.default)('#app1');
(0, _app2.default)("#app2"); //y就是app2.js导出的init方法
